...
import (
	...
	stockconsumer "github.com/zaytcevcom/msa/internal/stock_consumer"
...
func init() {
	flag.StringVar(
		&configFile,
		"config",
		"configs/stock_consumer_order_paid/config.toml",
...
func main() {
	...
	s := stockconsumer.New(logg, storage, consumer, producerSuccess, producerReject)
